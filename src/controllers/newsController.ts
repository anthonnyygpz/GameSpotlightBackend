...
import { NewsRow, NewsImageRow } from '../types';
...
export const getAll = async (
  ...
  try {
    ...
    const [rows] = await db.execute<(NewsRow & RowDataPacket)[]>(
...
export const getById = async (
  ...
  try {
    ...
    const [newsRows] = await db.execute<(NewsRow & RowDataPacket)[]>(
    ...
    const [images] = await db.execute<(NewsImageRow & RowDataPacket)[]>(
